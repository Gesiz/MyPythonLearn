...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tableWidget.setGeometry(QRect(0, 0, 402, 146))
...
"")
        ...
        self.comboBox.setGeometry(QRect(410, 0, 68, 22))
        self.tabWidget = QTabWidget(self.centralwidget)
        self.tabWidget.setObjectName(u"tabWidget")
        self.tabWidget.setGeometry(QRect(0, 150, 401, 301))
        self.Tab_1 = QWidget()
        ...
        self.pushButton.setGeometry(QRect(480, 0, 75, 24))
        ...
        self.tableWidget_2.setGeometry(QRect(0, 460, 946, 141))
        self.tableWidget_2.horizontalHeader().setVisible(True)
        self.tableWidget_2.verticalHeader().setVisible(False)
        self.verticalLayoutWidget = QWidget(self.centralwidget)
        self.verticalLayoutWidget.setObjectName(u"verticalLayoutWidget")
        self.verticalLayoutWidget.setGeometry(QRect(410, 50, 441, 381))
